 ...
 * 作者: chengx
 * 日期: 2016/11/8.
 * 描述: 空页面|错误页面|加载中页面处理，支持所有的布局
 */
public class EmptyLayout extends AutoLinearLayout {
